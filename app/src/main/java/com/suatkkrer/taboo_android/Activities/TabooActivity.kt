...
class TabooActivity : AppCompatActivity() {
    ...
    var teamPoint : Int = 0
    var firstTeamPass : Int = 1
    var secondTeamPass : Int = 1
...
//        word5.text = wordModel2.kelime5
        ...
        if (teamPoint == 0){
            var pointFirst = Integer.parseInt(firstTeamPoint.text.toString())
            pointFirst += 1
            firstTeamPoint.text = pointFirst.toString()
        } else {
            var pointSecond = Integer.parseInt(secondTeamPoint.text.toString())
            pointSecond += 1
            secondTeamPoint.text = pointSecond.toString()
        }
    }

    fun pasClick(view: View) {

        if (teamPoint == 0 && firstTeamPass <= pas) {
            var random = (0..(tabooList.size-1)).random()
        ...
        } else if (teamPoint == 1 && secondTeamPass <= pas) {
